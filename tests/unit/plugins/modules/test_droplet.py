...
class TestDropletGetMethods:
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.DigitalOceanFunctions.get_paginated')
    def test_get_droplets_by_name_and_region_empty(self, mock_get_paginated, mock_module, mock_client):
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.DigitalOceanFunctions.get_paginated')
    def test_get_droplets_by_name_and_region_single_match(self, mock_get_paginated, mock_module, mock_client, sample_droplet):
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.DigitalOceanFunctions.get_paginated')
    def test_get_droplets_by_name_and_region_filters_by_region(self, mock_get_paginated, mock_module, mock_client, sample_droplet):
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.DigitalOceanFunctions.get_paginated')
    def test_get_droplets_by_name_and_region_filters_by_name(self, mock_get_paginated, mock_module, mock_client, sample_droplet):
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.DigitalOceanFunctions.get_paginated')
    def test_get_droplets_by_name_and_region_multiple_matches(self, mock_get_paginated, mock_module, mock_client, sample_droplet):
...
class TestDropletPresent:
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.create_droplet')
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.get_droplets_by_name_and_region')
    def test_present_unique_name_multiple_droplets_fails(self, mock_get_droplets, mock_module, mock_client, sample_droplet):
...
class TestDropletAbsent:
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.delete_droplet')
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.get_droplets_by_name_and_region')
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.get_droplets_by_name_and_region')
    def test_absent_unique_name_not_found(self, mock_get_droplets, mock_module, mock_client):
    ...
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.get_droplets_by_name_and_region')
    def test_absent_unique_name_multiple_droplets_fails(self, mock_get_droplets, mock_module, mock_client, sample_droplet):
    ...
    def test_absent_by_id(self, mock_get_by_id, mock_delete, mock_module, mock_client, sample_droplet):
...
class TestDropletCreateDelete:
    ...
    @patch('time.sleep')
    @patch('ansible_collections.digitalocean.cloud.plugins.modules.droplet.Droplet.get_droplet_by_id')
    def test_delete_droplet_success(self, mock_get_by_id, mock_sleep, mock_monotonic, mock_module, mock_client, sample_droplet):
